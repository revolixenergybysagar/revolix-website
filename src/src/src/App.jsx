              ...
              <div className="space-y-6">
                <div className="bg-blue-500/10 border-l-4 border-blue-500 p-6 rounded">
                  <h4 className="font-bold text-blue-300 mb-2">ðŸ“¦ Consistent Supply</h4>
                  <p className="text-slate-400 text-sm">Reliable, high-quality recycled oil for production.</p>
                </div>
                <div className="bg-blue-500/10 border-l-4 border-blue-500 p-6 rounded">
                  <h4 className="font-bold text-blue-300 mb-2">ðŸ’Ž Lubricant Alternatives</h4>
                  <p className="text-slate-400 text-sm">Premium refined recycled oil for eco-friendly products.</p>
                </div>
                <div className="bg-blue-500/10 border-l-4 border-blue-500 p-6 rounded">
                  <h4 className="font-bold text-blue-300 mb-2">ðŸ’µ Cost-Effective Materials</h4>
                  <p className="text-slate-400 text-sm">High-quality at competitive sustainable prices.</p>
                </div>
                <div className="bg-blue-500/10 border-l-4 border-blue-500 p-6 rounded">
                  <h4 className="font-bold text-blue-300 mb-2">ðŸŒ± Eco-Certified Products</h4>
                  <p className="text-slate-400 text-sm">Boost brand with sustainable products.</p>
                </div>
              </div>
            </div>
          </div>
